...
<script>document.querySelectorAll('[data-year]').forEach(function(x){{x.textContent=new Date().getFullYear()}});</script>
        ...
        <div id="ed-article-social-popup" class="ed-article-social-popup" aria-hidden="true">
          <button type="button"
                  class="ed-article-social-close"
                  aria-label="Close"
                  onclick="edCloseArticleSocialPopup()">×</button>

          <div class="ed-article-social-head">
            <div>
              <span class="ed-article-social-kicker">STAY UPDATED</span>
              <strong>Exam Darpan से जुड़े रहें</strong>
              <p>नई vacancy, Admit Card, Result और exam updates सीधे पाएं।</p>
            </div>
          </div>

          <div class="ed-article-social-actions">

            <a class="ed-article-social-btn ed-wa"
               href="https://whatsapp.com/channel/0029VbDehpv4inozdwdMeY36"
               target="_blank"
               rel="noopener noreferrer">
              <span class="ed-social-icon" aria-hidden="true">
                <svg viewBox="0 0 32 32" role="img">
                  <path fill="currentColor" d="M16 3C8.82 3 3 8.82 3 16c0 2.29.59 4.53 1.71 6.5L3.1 29l6.67-1.56A12.94 12.94 0 0 0 16 29c7.18 0 13-5.82 13-13S23.18 3 16 3Zm0 23.65c-2.02 0-4-.54-5.73-1.56l-.41-.24-3.96.93.95-3.86-.27-.42A10.63 10.63 0 1 1 16 26.65Zm5.82-7.96c-.32-.16-1.9-.94-2.19-1.05-.29-.11-.5-.16-.71.16-.21.32-.81 1.05-.99 1.27-.18.21-.36.24-.68.08-.32-.16-1.34-.49-2.55-1.57-.94-.84-1.57-1.88-1.75-2.2-.18-.32-.02-.49.14-.65.14-.14.32-.36.47-.53.16-.18.21-.3.32-.51.11-.21.05-.39-.03-.55-.08-.16-.71-1.71-.97-2.34-.26-.61-.52-.53-.71-.54h-.61c-.21 0-.55.08-.84.39-.29.32-1.1 1.08-1.1 2.63s1.13 3.05 1.29 3.26c.16.21 2.23 3.41 5.4 4.78.75.32 1.34.51 1.8.65.76.24 1.45.2 2 .12.61-.09 1.9-.78 2.17-1.53.27-.75.27-1.39.19-1.53-.08-.13-.29-.21-.61-.37Z"/>
                </svg>
              </span>
              <span>
                <b>WhatsApp Channel</b>
                <small>Daily Jobs • Results • Admit Card</small>
              </span>
              <em>Follow →</em>
            </a>

            <a class="ed-article-social-btn ed-ig"
              ...
              <span>
                <b>Instagram</b>
                <small>Exam Tips • Updates • Short Content</small>
              </span>
              <em>Follow →</em>
            </a>
        ...
        .ed-article-social-popup.ed-show{
          opacity:1;
          transform:translateY(0) scale(1);
          pointer-events:auto;
        }

        .ed-article-social-close{
          position:absolute;
          right:10px;
          top:10px;
          width:34px;
        ...
        .ed-article-social-head{
          padding:3px 42px 14px 2px;
        }

        .ed-article-social-kicker{
          display:block;
          font-size:12px;
          font-weight:800;
          letter-spacing:.12em;
        ...
        .ed-article-social-actions{
          display:grid;
          gap:10px;
        }

        .ed-article-social-btn{
          display:flex;
          align-items:center;
          gap:12px;
          min-height:66px;
        ...
        .ed-article-social-btn > span:nth-child(2){
          min-width:0;
          flex:1;
        }

        .ed-article-social-btn b{
          display:block;
          font-size:15px;
          line-height:1.2;
          color:#172033;
        ...
        <script>
        (function(){
          var key = "ed_article_social_popup_closed";

          function show(){
            if(sessionStorage.getItem(key) === "1") return;
            var popup = document.getElementById("ed-article-social-popup");
            if(!popup) return;
            popup.classList.add("ed-show");
            popup.setAttribute("aria-hidden","false");
          }

          window.edCloseArticleSocialPopup = function(){
            var popup = document.getElementById("ed-article-social-popup");
            if(!popup) return;
            popup.classList.remove("ed-show");
