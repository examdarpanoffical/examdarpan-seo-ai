...
function isRajasthanPost(p={}){
  ...
  const national =
    /ssc|upsc|sbi|ibps|bank of india|india post|rrb|railway|central government|defence|army|air force|navy/.test(text);

  if(national) return false;

  return /rajasthan|rpsc|rssb|rsmssb|reet|cet|rajasthan police|patwari|vdo|ldc|junior assistant|rvunl|राजस्थान/.test(text);
}
